...
export class MemoryMathMultGame extends MemoryGame {
    constructor(config) {
        super({
            ...config,
            key: 'MemoryMathMultGame',
            title: 'Memory Multiplication',
            description: 'Match the multiplication operation with its result.',
            category: 'memory'
        });
    }
