...
> **Total Games:** 199 | **Completed:** 33 | **Remaining:** 166
> **Progress:** ████░░░░░░ 16.6%
...
| GCompris Activity | Priority | Status | Assigned |
|-------------------|----------|--------|----------|
| `align4` | P1 | ⬜ Not Started | - |
| `align4_2players` | P1 | ⬜ Not Started | - |
| `chess` | P1 | ⬜ Not Started | - |
| `chess_2players` | P1 | ⬜ Not Started | - |
| `tic_tac_toe` | P1 | ⬜ Not Started | - |
| `tic_tac_toe_2players` | P1 | ⬜ Not Started | - |
...
| GCompris Activity | Priority | Status | Assigned |
|-------------------|----------|--------|----------|
| `colors` | P1 | ⬜ Not Started | - |
| `advanced_colors` | P1 | ⬜ Not Started | - |
| `color_mix` | P1 | ⬜ Not Started | - |
| `color_mix_light` | P1 | ⬜ Not Started | - |
| `explore_farm_animals` | P1 | ⬜ Not Started | - |
| `explore_world_animals` | P1 | ⬜ Not Started | - |
